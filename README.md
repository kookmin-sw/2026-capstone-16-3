...
["길벗" 프로젝트 소개 영상](https://youtu.be/Z8eKX4Aa4Dc)
...
### 성북시각장애인복지관 2차 방문 — 실사용자 기능 테스트

<div align="center">
  <img src="docs/assets/images/성북시각장애인복지관_테스트.png" alt="성북시각장애인복지관 기능 테스트" width="90%">
</div>

- 저시력 시각장애인 직원 대상 시나리오 기반 기능 테스트
...
- **YOLOv11s** 모델로 사람, 차량, 자전거, 킥보드 등 객체를 인식하고, **YOLOv26n-SEG**로 보행 가능 영역을 분석하여 실제 위험 여부 판단
...
- 성북시각장애인복지관 1차 방문 — 흰지팡이 보행 체험  
  시각장애인 보행 환경 이해, 점자블록 단절 및 방향 감각 상실 문제 확인

- 성북시각장애인복지관 2차 방문 — 실사용자 기능 테스트  
  저시력 시각장애인 직원 대상 시나리오 기반 기능 테스트, 장애물 탐지·길찾기 사용성 검증 및 개선사항 피드백 수집

- 서울시립노원시각장애인복지관 방문 — 사용자 테스트 및 인터뷰  
  저시력 시각장애인 사용자 대상 앱 시연, 접근성 및 보행 안전 기능 피드백 수집

---

<div align="center">
© 국민대학교 2026 캡스톤 Team 리트리버 | 길벗 프로젝트
